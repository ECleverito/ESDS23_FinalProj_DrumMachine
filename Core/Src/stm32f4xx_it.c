...
void EXTI15_10_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(Button_11_Pin);
  HAL_GPIO_EXTI_IRQHandler(Button_12_Pin);
  HAL_GPIO_EXTI_IRQHandler(Button_13_Pin);
  HAL_GPIO_EXTI_IRQHandler(Button_14_Pin);
  HAL_GPIO_EXTI_IRQHandler(Button_15_Pin);
