...
#define Button_LED_6_Pin GPIO_PIN_11
#define Button_LED_6_GPIO_Port GPIOA
#define Button_LED_1_Pin GPIO_PIN_12
...
#define Button_LED_0_Pin GPIO_PIN_3
#define Button_LED_0_GPIO_Port GPIOD
#define DAC_RESET_Pin GPIO_PIN_4
#define DAC_RESET_GPIO_Port GPIOD
#define Button_LED_1D5_Pin GPIO_PIN_5
#define Button_LED_1D5_GPIO_Port GPIOD
